...
function crearClaseViajero() {
  class Viajero {
    ...
    addCompañero(nombre, nacionalidad, edad) {
      ...
      Viajero.compañeros.push(objeto);
    ...
    getCompañeros() {
      ...
      for( let clave in Viajero.compañeros){
              
           nuevoarray.push( Viajero.compañeros[clave].nombre); 
    ...
    getPaises() {
      ...
      for( let clave in Viajero.paises){
              
           nuevoarray.push( Viajero.paises[clave]); 
    ...
    for( let clave in Viajero.compañeros){
          ...
          suma= suma + Viajero.compañeros[clave].edad; 
          contador=contador +1;
